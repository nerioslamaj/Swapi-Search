# `angular-seed` was used for this project
...
To get you started you can simply clone the `Swapi-Search` repository and install the dependencies:

### Clone `Swapi-Search`

Clone the `Swapi-Search` repository using git:

```
git clone https://github.com/nerioslamaj/Swapi-Search.git
cd Swapi-Search
```
